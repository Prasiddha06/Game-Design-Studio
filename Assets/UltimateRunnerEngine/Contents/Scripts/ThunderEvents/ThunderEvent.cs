...
namespace ThunderEvents
{
    ...
    public class ThunderEvent
    {
        ...
        public ThunderEvent() { }
        public ThunderEvent(Delegate call) { Set(call); }
        public ThunderEvent(UnityEngine.Object target, string methodName) { Set(target, methodName); }
    ...
    static bool IsValid (Delegate callback) { return callback != null; }
        ...
        static int s_Hash = "ThunderEvent".GetHashCode();
        ...
        static public ThunderEvent Add(List<ThunderEvent> list, Delegate callback) { return Add(list, callback, false); }
        ...
        static public void Add(List<ThunderEvent> list, ThunderEvent ev) { Add(list, ev, ev.oneShot); }
        ...
        static public bool Remove(List<ThunderEvent> list, Callback callback)
        {
            if (list != null)
            {
                ThunderEvent del = null;
