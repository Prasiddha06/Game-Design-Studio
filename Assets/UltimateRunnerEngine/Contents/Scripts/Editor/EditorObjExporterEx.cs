...
public class EditorObjExporterEx : ScriptableObject
{
    ...
    [MenuItem("Game Tools/Export/Export all MeshFilters in selection to separate OBJs")]
    ...
    [MenuItem ("Game Tools/Export/Export whole selection to single OBJ")]
    ...
    [MenuItem("Game Tools/Export/Export each selected to single OBJ")]
